...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    $scope.initMap = function(){
      ...
      leafletData.getMap().then(function(map) {
        ...
        console.log("Geladene \"Marker\" ID => ", (editableLayers._leaflet_id)); // Die Marker sind ein Objekt mit Objekten!! Kein Array mit Objekten o.ä.
        leafletData.getLayers().then(function() {
          ...
          function rectangleClick(e){
            ...
            console.log("CLICK: var polygon ",$scope.polygon);
            let layers = e.layer;
